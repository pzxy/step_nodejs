...
//   fee: 100n,
//   recipient: '0x2156dF574320bc8d30B370892d8E0e30a3c4A869',
//   amountOut: 100000000000000n,
//   amountInMaximum: 10325482300079436n,
...
let sig = web3.eth.abi.encodeFunctionCall(
    ...
    [
        ...
        100n,
        "0x2156dF574320bc8d30B370892d8E0e30a3c4A869",
        100000000000000n,
        10325482300079436n,
        0n]
);
const bscFuncHexForExactInputSingle = '0x04e45aaf';
sig = bscFuncHexForExactInputSingle + sig.substring(10, sig.length);
console.log(sig);

// encode multicall:
let deadline = 1704790319n;
let data = sig;
